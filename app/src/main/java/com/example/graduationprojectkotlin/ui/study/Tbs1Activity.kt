...
import kotlinx.android.synthetic.main.activity_tbs1.*
import java.io.File
import java.text.DecimalFormat
import kotlin.properties.Delegates

class Tbs1Activity : AppCompatActivity(), TbsReaderView.ReaderCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tbs1)
